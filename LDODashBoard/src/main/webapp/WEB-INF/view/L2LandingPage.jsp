...
<iframe id="mainContent" src="/LDODashBoard/L2SrcLinkPage.htm"  width=20% scrolling="no" onload="resizeIframe(this);"></iframe>
<iframe id="displayContent"  src="/LDODashBoard/L2OutputDisplayPage.htm" width=78% scrolling="yes" onload="resizeIframe(this);"></iframe>
